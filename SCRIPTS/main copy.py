...
if __name__ == "__main__":
    ...
    # employee_ids.to_csv(r"C:\PROJECTS\INBOUD_IDOC\INPUT\Employee_id\employee_id.csv", index=False, header=False)
    ...
    # employee_status_path = r"C:\PROJECTS\INBOUD_IDOC\INPUT\ADITIONAL_ REQUIREMENTS\employee status data\downloaded_employee_status_data.xlsx"
    ...
    # material_csv_path = "C:\PROJECTS\INBOUD_IDOC\INPUT\ADITIONAL_ REQUIREMENTS\material numbers\material_numbers.csv"
    ...
    # division_csv_path = r"C:\PROJECTS\INBOUD_IDOC\INPUT\ADITIONAL_ REQUIREMENTS\Division\Division.csv"
    ...
    # division_path = r"C:\PROJECTS\INBOUD_IDOC\INPUT\ADITIONAL_ REQUIREMENTS\Division\downloaded_data_division.xlsx"
    ...
    # CURRENTLY AVAILABLE ACTIVITY CATEGORY
    ...
    extracted_df = psa_work_order.apply(
        lambda row: pd.Series({
            "DOCNUM": row["DOCNUM"],
            "Extracted Elements": " ".join(row["SDATA"].split()[-4:-1])
        }),
        axis=1
    )
    ...
    # activity_category_csv_path =  r"C:\PROJECTS\INBOUD_IDOC\INPUT\PSA ACTIVITY CATEGORY\activity_category.csv"
    ...
    # activity_category_data_psa = r"C:\PROJECTS\INBOUD_IDOC\INPUT\PSA ACTIVITY CATEGORY\activity_category_data_psa.xlsx"
